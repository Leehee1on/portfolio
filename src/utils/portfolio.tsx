...
export const info = {
  ...
  desc: [
    emoji("• 2019년도에 개발 일을 처음으로 시작하여, 2년 반 정도 개발일을 경험하였습니다."),
    emoji("• Javascript / React / React Native 를 다루는데 능숙하며, Android / IOS 배포 경험이 있습니다."),
    emoji("• 백엔드쪽 공부를 하고있으며, 채팅서버를 만들어본 경험이 있습니다."),
